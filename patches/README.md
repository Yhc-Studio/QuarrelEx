...
```text
compatibility/MidCity2_to_QuarrelEx_Runtime6.9.3.ips
```
...
```text
CRC32:   6CF268F2
SHA-256: 0d0fd62cd06e26348b0e84f0cf7b4dcaca88ed22ead70ef9da1588b556264dff
```
...
```text
compatibility/MidCity2_PS_to_QuarrelEx_Runtime6.9.3.ips
```
...
```text
CRC32:   7549DE04
SHA-256: abb695349e6cc96b477b7321ee00dc46fd253f8bd91d6651992d1010e2a49d2f
```
