...
Use `docs/Release_v1.0.md` as the release-note starting point.

Recommended release assets are prepared separately in the companion `QuarrelEx_v1.0_ReleaseAssets.zip`.
